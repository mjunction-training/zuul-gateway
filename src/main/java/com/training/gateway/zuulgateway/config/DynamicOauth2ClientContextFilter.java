 ...
 *
 * public class DynamicOauth2ClientContextFilter extends
 * OAuth2ClientContextFilter {
 *
 * private RedirectStrategy redirectStrategy = new DefaultRedirectStrategy();
 *
 * @Override protected void redirectUser(final UserRedirectRequiredException e,
 * final HttpServletRequest request, final HttpServletResponse response) throws
 * IOException {
 *
 * final String redirectUri = e.getRedirectUri(); final UriComponentsBuilder
 * builder = UriComponentsBuilder.fromUriString(redirectUri); final Map<String,
 * String> requestParams = e.getRequestParams();
 *
 ...
 *
 * @Override public void setRedirectStrategy(final RedirectStrategy
 * redirectStrategy) { this.redirectStrategy = redirectStrategy; }
 *
 * private String getBaseUrl(final HttpServletRequest request) { final
 * StringBuffer url = request.getRequestURL(); return url.substring(0,
